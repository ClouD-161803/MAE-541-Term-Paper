...
%%
    ...
    \begin{equation} \label{eq: energy E2}
        ...
        E_2 \approx -1.592,
    \end{equation}
    the energy value (in dimensionless CR3BP units) corresponding to the Lagrange point $\mathcal{L}_2$. We refer to the region enclosed by this surface as the \textit{accessible region}, as it comprises all states of the form $(x,0,v_x,v_y)$ that have an energy level at or below $E_2$. 
