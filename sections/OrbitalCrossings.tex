...
\subsection{Orbital Crossings} \label{subsec:Orbital Crossings}
    ...
    These depictions are done on several Poincaré sections, using the Jacobi constant, $C$, as a proxy for energy. One can see that for $C$ closer to $3.2$, approximately the Jacobi constant correlating to $E_2$ (recall \cref{eq:jacobi_integral} and \cref{eq: energy E2}), the chaotic nature of the system becomes increasingly prominent.
    % MINOR ADJUSTMENT MADE HERE
